...
const Login =() =>{
    return (
        ...
        <div id="center">
            ...
            <h1 class="text-center margin-15 padding-15"> uLearn Login</h1>
            <form title="SF State Global Login">

            <div class="form-group">
                                    <label for="username" >SF State ID or Email</label>
                                    <input class="form-control" id="username" name="j_username" type="text" tabindex="1"
                                               value="" autofocus></input>
            </div>

            <div class="form-group">
                                    <label for="password" class="control-label" >SF State Password</label>
