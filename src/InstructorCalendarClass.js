                                ...
                                <Row class='overflow-auto'>
                                    ...
                                    <Accordion>
                                        <Accordion.Item eventKey='0'>
                                            ...
                                            <Accordion.Body>
                                                <ul>
                                                    <Card>
                                                        <Container style={{ backgroundColor: '#DD3544' }}><Card.Title style={{ marginTop: '10px', color: 'white' }}>Quiz 1<PencilSquare style={{ marginLeft: '10px' }} color='white' /></Card.Title></Container>
                                                        <Card.Body>
                                                            <Container>
                                                                <Row style={{ alignItems: 'center' }}>
                                                                    <Col>
                                    ...
                                    <Accordion style={{ paddingBottom: '4%' }}>
                                        <Accordion.Item eventKey='0'>
                                            ...
                                            <ul>
                                                    <Card>
                                                        <Container style={{ backgroundColor: '#3F8755' }}><Card.Title onClick={()=>setEventModalShow(true)} style={{ marginTop: '10px', color: 'white' }}>Event 1<PencilSquare style={{ marginLeft: '10px' }} color='white' /></Card.Title></Container>
                                                        <Card.Body>
                                                            <Container>
                                                                <Row style={{ alignItems: 'center' }}>
                                                                    <Col>
